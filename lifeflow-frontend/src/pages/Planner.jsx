        ...
        {isModalOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-x-4 top-10 md:inset-0 md:m-auto max-w-lg h-fit max-h-[90vh] bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-2xl z-50 flex flex-col overflow-hidden"
            >
